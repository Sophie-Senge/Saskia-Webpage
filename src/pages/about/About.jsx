    ...
    return (<>
        ...
        <section className='container mx-auto md:px-2 py-16 w-1/2'>
            <div className='justify-center'>
                ...
                <br />
                <p className='text-sm text-justify'>Who were these vessels? Were they contained by the potter’s hands, or were they the container? They would spend most of their lives empty. We could not live without them. Some we would come to treasure with use. Others, the least utilized, might be buried for thousands of years and become treasure in a local museum, for instance on a Cycladic island.</p>
