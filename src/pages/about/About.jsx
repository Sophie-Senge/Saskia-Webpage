...
<img className='mr-10' src={aboutOne} alt="saskia spender" />
        ...
        <div className='mx-auto justify-center h-screen w-full'>
            ...
            <h3 className='text-lg text-neutral-800 font-semibold font-headings tracking-widest pb-14 grid items-end justify-items-center'>Some reflections by Saskia Spender</h3>
        </div>
        </>
    )
}
